  ...
  <jsp:include page="../header.jsp" />
    ...
    <section class="blog-section">
	  <div class="selectBox mb20">
	  	<div class="btn-box">
	  	<form action="/recruit/filterList">
      ...
      <div class="container">
        <c:forEach items="${filterlist2 }" var="dto" varStatus="status">
	        <div class="blog-list" class="link-box" onclick="document.location.href='/recruit/recruitmentpostview?id=${dto.id }'">
	          <div class="blog-item">
		          	<div class="badge fon-11 mb10 plus">${filterlist[status.index].skill.name}</div>
		            <div class="blog-content plus">
		              <p class="blog-date mb5 mt20 fon11 plus fon-bold">마감일 | ${filterlist[status.index].study.recruit_period}</p>
		              <h3 class="mt30"> ${dto.title}</h3>
		            </div>
		            <div class="blog-foot">
		            	<div>
		            		<span class="fon-bold">${dto.title}</span>
		            	</div>
		            	<div class="view">
