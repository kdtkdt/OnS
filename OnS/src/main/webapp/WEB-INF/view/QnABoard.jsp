  ...
  <div id="post-container">
    ...
    <section class="qna-post-section">
      <div class="selectBox mb20">
        ...
        <div class="btn-box">
          <div id="search-box">
            <input type="text" id="search-input" class="fon-15" placeholder="궁금한 것을 검색하세요."></input>
            <button id="search-btn" class="button ml10 pt5 pb5 pl20 pr20 fon-13 mr10">검색</button>
          </div>
          <div id="question-btn-box">
            <button id="question-btn" class="button ml10 pt5 pb5 pl20 pr20 fon-13 mr10">질문 하기</button>
          </div>
        </div>
      </div>
      <div class="container">
    ...
    <div id="right-menu">
      <div id="popular-tag-box">
        ...
        <div id="popular-tag-container" class="mb20">
          ...
          <span class="tag fon-11">#Java</span>
        </div>
      </div>
    </div>
  </div>
